...
// import reviewerImage1 from "../../assets/xavior.jpeg";
import reviewerImage1 from '../../assets/xaviour.jpeg'
    ...
    <section className="container mx-auto mb-8 mt-12" id="review">
      <div className="flex flex-col">
        ...
        <div className="flex items-center justify-center gap-6">
            <img src={reviewerImage1} alt={REVIEW.name} width={80} height={80} className="rounded-full border" />
